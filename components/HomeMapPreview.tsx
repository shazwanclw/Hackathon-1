...
export default function HomeMapPreview({ cases }: { cases: AnimalMapMarker[] }) {
  const points = cases
  ...
  return (
    <div className="h-[44vh] overflow-hidden rounded-2xl border border-brand-700/80 shadow-[0_14px_34px_rgba(80,55,27,0.2)]">
      <MapContainer center={center} zoom={points[0] ? 12 : 6} scrollWheelZoom={false} dragging={false} className="h-full w-full">
        <TileLayer
